...
import UserImage from '../../assets/image4.png'
// import SearchImage from '../../assets/Searchvector.png'

const Header = () => {
  return (
    <nav className="header flex-center">
        <div className="header__inner">
            <div className="logo__container">
                <img src={GroupLogo} alt="Lendersqr" className="logo flex-center" />
            </div>
            <div className="search__con">
                <div className="seach_inner">
                    <input type="search" className="control_search" placeholder="Search for anything" />
                    <button className="btn_search"></button>
                </div>
            </div>
            <div className="nav__con flex-center">
                <div className="navcon__p">Doc</div>
                ...
                <div className="navcon flex-center">
                    <div className="user_nav_image">
